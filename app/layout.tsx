...
import DiscordScript from "@/components/DiscordScript";
...
const getBaseUrl = () => {
  ...
  if (process.env.VERCEL_PROJECT_PRODUCTION_URL) {
    try {
      baseUrl = new URL(`https://${process.env.VERCEL_PROJECT_PRODUCTION_URL}`)
        .toString()
        .replace(/\/$/, "");
    } catch (error) {
...
export const metadata: Metadata = {
  ...
  description:
    "OpenTierBoy: The free, open-source tier list creator that helps you craft, rank and share your passion! No ads, no logins, no sign-ups. Create and instantly share your tier lists simply by copying the URL to your tier list.",
  keywords:
    "tier list, maker, creator, generator, open-source, free, share, rank, community, tier maker, rank, rankings, game",
  openGraph: {
    title: "OpenTierBoy - Craft, Rank, and Share Your Tier Lists",
    description:
      "OpenTierBoy: The free, open-source tier list creator that helps you craft, rank and share your passion! No ads, no logins, no sign-ups. Create and instantly share your tier lists simply by copying the URL to your tier list.",
...
const STRUCTURED_METADATA = {
  ...
  name: "OpenTierBoy",
  description:
    "OpenTierBoy: The free, open-source tier list creator that helps you craft, rank and share your passion! No ads, no logins, no sign-ups. Create and share your tier lists instantly simply by copying the URL to your tier list.",
  url: baseUrl,
  ...
  potentialAction: [
    ...
    },
    {
      ...
      description:
        "Rank equipments and specializations from The Finals in your own tier list and share it with the community",
    },
    {
      "@type": "ViewAction",
      ...
      description:
        "Rank Wuthering Waves Resonators in your own tier list and share it with the community",
    },
    {
      "@type": "ViewAction",
      ...
      description:
        "Rank Overwatch Heroes in your own tier list and share it with the community",
    },
    {
      "@type": "ViewAction",
    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        >
          ...
          <footer
            className="w-full mt-8 py-8 border-t hide-in-zen"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 text-center sm:text-start gap-8 items-start">
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="flex flex-row space-x-4 h-5 justify-center sm:justify-start">
                    ...
                    <Separator orientation="vertical" />
                    <a
                      href="mailto:opentierboy@infinia.space"
                ...
                <div className="flex flex-col items-center justify-center space-y-4 p-4">
                  <div className="flex space-x-2">
                    <Button variant="ghost" asChild size="icon">
                      <a
                        href="https://github.com/infinia-yzl/opentierboy"
                    ...
                    <Button variant="ghost" asChild size="icon">
                      <a
                        href="https://discord.gg/CEtDSHV38b"
                        className="text-foreground hover:text-primary"
                        aria-label="Discord"
                      >
